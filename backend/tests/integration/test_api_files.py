...
@pytest.mark.asyncio
async def test_upload_valid_csv(api_client):
...
@pytest.mark.asyncio
async def test_upload_sanitization(api_client):
...
@pytest.mark.asyncio
async def test_upload_process_delete_flow(api_client):
    """
    Full Lifecycle Test:
    1. Upload File
...
@pytest.mark.asyncio
async def test_delete_nonexistent_file(api_client):
